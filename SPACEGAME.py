...
# background
background = pygame.image.load('spacegamebg.png')
bg = pygame.transform.scale(background, (800, 600))
q = 0
height = 600

# Player
playerimg = pygame.image.load('spaceshipplayer.png')
playerX = 370
playerY = 480
playerX_change = 0
...
for i in range(num_of_enemies):
    enemyimg.append(pygame.image.load('spaceshipenemy.png'))
...
# score
score = 0
font = pygame.font.Font('Coffee Spark.ttf', 32)

textX = 10
textY = 10

# game over text
over_font = pygame.font.Font('Coffee Spark.ttf', 64)
